...
<body>
        ...
        <div class="container-fluid">
            ...
            <img src="assets/img/LOGO.png"  alt="" style="width: 7%;">          
              ...
              <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                  <a class="nav-link active" href="development.jsp">Developers</a>
                </li>
  ...
  <main id="main">
    ...
    <!-- ======= Breadcrumbs ======= -->
    <div class="breadcrumbs" data-aos="fade-in" style="margin-top: 30px;">
      <div class="container">
        <h2>Contact Us</h2>
        <p>It is a pleasure and sorrows, that they should not be elected in some cases we may be able to do. It was from this, or something similar because it is pleasure, look for the debts. No one of these will open the very laborious, all the consequences of things, of current events. </p>
      </div>
    </div><!-- End Breadcrumbs -->
  ...
  <footer id="footer">
    ...
    <div class="container d-md-flex py-4">
      ...
      <div class="me-md-auto text-center text-md-start">
        <div class="copyright">
          &copy; Copyright <strong><span>Developers</span></strong>. All Rights Reserved
        </div>
        <div class="credits">
          ...
          Designed by <a href="index.jsp/">Developers</a>
        </div>
      </div>
